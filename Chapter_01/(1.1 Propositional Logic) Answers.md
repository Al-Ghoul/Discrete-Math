...
Because an inclusive OR is used along with a negation, flipping each value once in each OR operation that would lead for atleast one FALSE result between the AND operators which will lead to a FALSE result.
...
Because we are flipping ALL values in the other side of the AND operation, which would lead to a FALSE result if all values are the same in the OR operation(s).
___
...
a) 101 1110, 010 0001<br/>
b) 1111 0000, 1010 1010<br/>
c) 00 0111 0001, 10 0100 1000<br/>
d) 11 1111 1111, 00 0000 0000<br/>
...
a) 1 1000 ∧ (0 1011 ∨ 1 1011)<br/>
b) (0 1111 ∧ 1 0101) ∨ 0 1000<br/>
c) (0 1010 ⊕ 1 1011) ⊕ 0 1000<br/>
...
a) “Fred is happy, or John is happy”<br/>
b) “red is not happy, or John is not happy”
